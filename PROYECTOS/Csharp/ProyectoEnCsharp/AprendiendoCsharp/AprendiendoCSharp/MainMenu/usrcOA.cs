...
{
    public partial class usrcOA : UserControl
    {
        public usrcOA()
        {
            InitializeComponent();
        ...
        private void usrcOA_Load(object sender, EventArgs e)
        {
        ...
        private void resta0_Click(object sender, EventArgs e)
        {
            Suma();
        }

        private void suma0_Click(object sender, EventArgs e)
        {
            Resta();
        }
